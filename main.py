...
video_update_args.add_argument("name", type=str, help="Name of the the video is required", )
...
class Video(Resource):
    ...
    def put(self, video_id):
        ...
        db.session.commit()
        return video, 201  # send response that this video id was created
    ...
    def patch(self, video_id):
        ...
        result = VideoModel.query.filter_by(id=video_id).first()
        if not result:
            abort(404, message="Video does not exist, so cannot be updated")
